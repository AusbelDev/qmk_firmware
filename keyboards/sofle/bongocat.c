...
void render_bongocat(void) {
    ...
    void animation_phase(void) {
        ...
        } else if (wpm > IDLE_SPEED && wpm < ANIM_WPM_LOWER) {
    ...
    curr_anim_duration = (wpm > ANIM_WPM_LOWER) 
        ? MAX(ANIM_FRAME_DURATION_MIN, ANIM_FRAME_DURATION_MAX - (uint32_t)(ANIM_FRAME_RATIO * wpm))
        : IDLE_FRAME_DURATION;
